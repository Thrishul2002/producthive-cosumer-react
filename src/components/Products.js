...
function Products() {
  ...
  //state management using useState()-ractHook- use 'ush'
   ...
   //reactHook-runs only once on the first render
   useEffect(() => { //use ueh for useEffect method
    fetchProducts();
    }, []);
